    ...
    return (
        <div id="cont">
            ...
            <form className="d-flex responsive-home" id='searchSection'>
                ...
                <input className="form-control  mt-10 rounded-pill" type="text" pattern="[a-zA-Z]*" placeholder="Enter Area or Agent For Property Details" id="area" name='area' onChange={onChange} value={area} aria-label="Search" required />
                <Link 
                    className={`btn btn-primary mx-1 border-search ${type === "" ? "disabled" : ""}`} 
            ...
            <div className='container'>
                <div className="d-flex justify-content-between responsive-cards">
                    <div className="card custom-card" style={{ width: "18rem", borderRadius: "0.65rem", backgroundColor: 'whitesmoke' }}>
                        ...
                        <h6 className="card-title" style={{ margin: '2px auto', color: 'rgb(65, 65, 199)' }}>Buy Property</h6>
                    ...
                    <div className="card custom-card" style={{ width: "18rem", borderRadius: "0.65rem", backgroundColor: 'whitesmoke' }}>
                        ...
                        <h6 className="card-title" style={{ margin: '2px auto', color: 'rgb(65, 65, 199)' }}>Rent Property</h6>
                        <p className="card-text" style={{ margin: '20px auto', color: 'rgba(53, 51, 51, 0.712)' }}>Benefits that fit right be it any site</p>
                    </div>

                    <div className="card custom-card" style={{ width: "18rem", borderRadius: "0.65rem", backgroundColor: 'whitesmoke' }}>
                        <img src={buyImg} id="sloganCardImg" />
                        <h6 className="card-title" style={{ margin: '2px auto', color: 'rgb(65, 65, 199)' }}>Sell Property</h6>
